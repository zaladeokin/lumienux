        ...
        echo <<<_cart
            <div class="cart" id="cart_$item_count">
                ...
                <div>
                    ...
                    <span>$i_stock stocks available</span>
                </div>
                <div>
                    <strong>Quantities&nbsp;<input type="number" id="p_qty_$item_count" min="1" max="$i_stock" value="1" $input_disable></strong><button>Remove</button>

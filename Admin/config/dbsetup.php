...
createTable('orders','id INTEGER NOT NULL AUTO_INCREMENT, tx_ref varchar(255) NOT NULL, email varchar(255) NOT NULL, phone varchar(13), address TEXT, product_id TEXT NOT NULL, product_qty TEXT NOT NULL, amount INTEGER NOT NULL, status ENUM("0", "1") DEFAULT "0", payment_info LONGTEXT, PRIMARY KEY(id)', $admin);

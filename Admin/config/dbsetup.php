...
createTable('product','id INTEGER NOT NULL AUTO_INCREMENT, name varchar(255) NOT NULL UNIQUE, description TEXT NOT NULL, price INTEGER NOT NULL, stock INTEGER NOT NULL, category ENUM("1", "2", "3", "4", "5", "6") DEFAULT "6", img VARCHAR(255),sold_product INTEGER DEFAULT "0", delivery_class ENUM("1", "2", "3") DEFAULT "1", PRIMARY KEY(id)', $admin);

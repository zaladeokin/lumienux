 ...
 */
createTable('admin','id INTEGER NOT NULL AUTO_INCREMENT, email varchar(255) NOT NULL, password varchar(255) NOT NULL, PRIMARY KEY(id)', $admin);
...
createTable('product','id INTEGER NOT NULL AUTO_INCREMENT, name varchar(255) NOT NULL, description TEXT NOT NULL, price INTEGER NOT NULL, stock INTEGER NOT NULL, category ENUM("1", "2", "3", "4", "5") DEFAULT "5",PRIMARY KEY(id)', $admin);
